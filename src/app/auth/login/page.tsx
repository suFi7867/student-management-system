...
function LoginContent() {
    ...
    return (
        <div className="min-h-screen flex">
            {/* Left Panel - Branding */}
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-sky-600 relative overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative z-10 flex flex-col justify-center items-center text-white p-12 w-full">
                    ...
                    <h2 className="text-4xl font-bold text-center mb-4">
                        Welcome to Online Student Management System
                    </h2>
                    <p className="text-lg text-white/80 text-center max-w-md mb-12">
                        A comprehensive platform for managing academic activities, attendance, grades, and communication.
                    </p>

                    {/* Features */}
                    <div className="grid grid-cols-2 gap-6 w-full max-w-md">
                        {[
                            { title: "Role-Based Access", desc: "Admin, Faculty & Student portals" },
                            { title: "Real-Time Updates", desc: "Instant attendance & grade updates" },
                            { title: "Mobile Friendly", desc: "Access from any device" },
                    ...
                    <Card className="border-0 shadow-xl">
                        ...
                        <CardContent>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <form action={async (formData) => { await signInWithGoogle(formData) }}>
                                ...
                                <form action={async (formData) => { await signInWithGitHub(formData) }}>
                                    <Button variant="outline" type="submit" className="w-full">
